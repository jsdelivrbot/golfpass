    ...
    <div id="content">
        ...
        <section class="blog style-2 padding-bottom-80">
            <div class="container">
                ...
                <?php }else{?>
                    <li class="tab-title filter-item">
                    <a href="<?=site_url(shop_product_uri."/gets_by_hash/{$search}")?>" data-filter=".pf-branding-design" style="font-family: 'notokr-regular', sans-serif; font-size: 12px; font-weight: normal;">
                    상품 목록<?="({$num_products})"?>
                    </a>
                </li>
                <li class="tab-title filter-item">
                    <a href="<?=site_url(shop_package_uri."/gets_by_hash/{$search}")?>" data-filter=".pf-branding-design" class="active" style="font-family: 'notokr-regular', sans-serif; font-size: 12px; font-weight: normal;">
					패키지 목록<?="({$num_packages})"?>
                    </a>
                </li>
                    <li class="tab-title filter-item">
                        ...
                        <div class="col-md-4 margin-bottom-80" style="cursor: pointer;" onclick="location.href='<?=site_url(shop_package_uri."/get/{$packages[$i]->id}")?>';">
                            <article class="blog-post">
                                <div class="post-img position-relative rounded-top" style="background-image:url(<?=$packages[$i]->photo?>); background-repeat:no-repeat; background-position:center; background-size:cover">
                                    <img src="/public/icon/label_hotelstay.png" style="width: 84px; float: right; margin-right: 10px;"> <!-- 상품라벨 -->
