...
<form   action="<?=my_site_url(admin_hotel_uri."/options_reset")?>" method ="post">
  <input type="checkbox" name="option[]" value="1인실" <?=my_set_checked_arr($options,'name','1인실')?>> 1인실<br>
  <input type="checkbox" name="option[]" value="특급호텔" <?=my_set_checked_arr($options,'name','특급호텔')?>>특급호텔<br>
