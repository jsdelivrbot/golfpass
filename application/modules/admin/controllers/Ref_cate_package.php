...
class Ref_cate_package extends Admin_Controller {

    function __construct(){
        parent::__construct( array(
            'table'=>'shop/ref_cate_package'
        ));
    }
  ...
  my_redirect($_SERVER['HTTP_REFERER']);
    ...
    function ajax_add()
    {
        ...
        if(!$this->fv->run()){
            ...
            $this->ref_cate_package_model->_add();
        }
        $data['reload'] =true;
    ...
    {
        $this->ref_cate_package_model->_delete($id);
        $data['reload'] =true;
        echo json_encode($data);
    }
    ...
    public function ajax_update($id)
    {
        ...
        $this->_dbset_addUpdate();
        $this->ref_cate_package_model->_update($id);
