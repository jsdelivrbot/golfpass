    ...
    <div class="menu-container position-fixed">
        ...
        <div class="menu">
            <ul class="list-unstyled">
                ...
                <?php }?>
                    <li><a style="font-family: 'notokr-regular', sans-serif; font-size: 25px; font-weight: normal; color: #fff;" href="<?=site_url(shop_category_uri.'/gets_by_name/나라별')?>">나라별 골프장</a></li>
