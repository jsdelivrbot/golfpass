...
<ul class="ui ul">
    ...
    <li style="color:red">전체 - 인터컴 탑재</li>
    <li>푸터 - 파트너 변경</li>
    <li style="color:red">푸터 - 뉴스레터 기능 활성화</li>
    <li>헤더 - 햄버거 메뉴 배너 추가</li>
</ul>
<ul>
    <li>메인 - 전체 폰트 속성 체크</li>
    <li>메인 - 전체 여백 속성 체크</li>
    <li style="color:red">메인 - s1 영어 이름 연동</li>
    <li>메인 - 헤더/푸터 정돈</li>
    ...
    <li style="color:red">메인 - 순위별 골프장 숫자 이상하게 뜨는 문제 해결</li>
    <li style="color:red">메인 - 순위별 골프장 카테고리 변경 시 카테고리명 이상해지는 문제</li>
