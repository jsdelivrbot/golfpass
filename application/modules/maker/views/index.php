...
<li>메인 섹션 1에서 SNS 버튼 링크 추가</li>
<li>메인 섹션 1에서 SNS 리스트 중 유튜브 추가</li>
<li>메인 섹션 1에서 상품명 축소</li>
<li>메인 섹션 1에서 소개말 삭제</li>
<li>메인 섹션 1에서 넘어갈 때 속도를 증가시켜 답답함을 없애야 함</li>
<li>메인 섹션 1에서 홀과 야드 표기 삭제</li>
<li>나라별 골프장부터 메뉴를 활성화 했을 때 메뉴를 비활성화 없는 상황 조치</li>
<li>나라별 골프장부터 캄보디아와 미얀마 같이 있지 않도록 조치</li></li>
<li>나라별 골프장에서 필리핀 이미지 변경</li>
...
<ul>
    <li>패널 페이지 - 헤더/푸터 정상 출력</li>
    <li>패널 페이지 - 개인 패널 페이지로 접근하면 미리보기가 모두 펼쳐지며 포스팅 미리보기 옆 이미지가 프로필 사진이 되는 현상</li>
    <li>패널 페이지 - 게시글 리스트 중 1페이지가 아닌 페이지에 접근하면 미리보기가 모두 펼쳐지며 포스팅 미리보기 옆 이미지가 프로필 사진이 되는 현상</li>
    <li>패널 페이지 - 미리보기에서 이미지가 사라진 자리에 띄어쓰기가 남는 현상</li>
</ul>
<ul>
    <li>패널 포스팅 재작업</li>
</ul>
