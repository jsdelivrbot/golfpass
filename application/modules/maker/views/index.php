...
<ul class="ui ul">
    ...
    <li style="red">전체 - 인터컴 탑재</li>
    <li>푸터 - 파트너 변경</li>
    <li style="red">푸터 - 뉴스레터 기능 활성화</li>
    <li>헤더 - 햄버거 메뉴 배너 추가</li>
</ul>
<ul>
    <li>메인 - 전체 폰트 속성 체크</li>
    <li>메인 - 전체 여백 속성 체크</li>
    <li style="red">메인 - s1 영어 이름 연동</li>
    <li>메인 - 헤더/푸터 정돈</li>
    <li>메인 - 햄버거 메뉴 리스트 정돈</li>
    <li style="red">메인 - 실시간 검색 기능 정상 작동</li>
    <li style="red">메인 - 검색창에서 엔터쳤을 때 검색 결과 페이지로 이동</li>
    <li>메인 - s1에서 넘어갈 때 속도를 증가시켜 답답함을 없애야 함</li>
    <li>메인 - 나라별 골프장부터 메뉴를 활성화 했을 때 메뉴를 비활성화 없는 상황 조치</li>
    <li style="red">메인 - 골프패스 패널이 추천하는 골프장 가격 연동</li>
    <li style="red">메인 - 순위별 골프장 리스트에서 점수도 표기</li>
    <li>메인 - 골프패스 패널이 추천하는 골프장에서 골프 숙박 메세지 변경, 배경색도 변경</li>
    <li>메인 - 순위별 골프장 카테고리명 수정</li>
    <li>메인 - 시설이 고저스한 이름 수정</li>
    <li style="red">메인 - 순위별 골프장 숫자 이상하게 뜨는 문제 해결</li>
    <li>메인 - 순위별 골프장 모바일 해결</li>
    <li>메인 - 로그인 시 프로필 사진 출력</li>
</ul>
<ul>
