...
<?php if($mode === 'add'){?>
 아이디<input placeholder="아이디" type="text" name="userName" value="<?=set_value('userName')?>"/>
 <?=form_error('userName',false,false)?>
<?php }else if($mode === 'update'){
    echo $user->userName;
} 
    ?>
 <br/>
 비번<input placeholder="비번" type="password" name="password" value="<?=set_value('password')?>" />
 <?=form_error('password',false,false)?>
 <br/>
 비번확인<input placeholder="비번확인" type="password" name="re_password" value="<?=set_value('re_password')?>" />
 <?=form_error('re_password',false,false)?>
 <br/>
...
<?=form_error('postal_number',false,false)?><br>
<?=form_error('address',false,false)?><br>
<?=form_error('address_more',false,false)?><br>
...
<img src="//t1.daumcdn.net/localimg/localimages/07/postcode/320/close.png" id="btnFoldWrap" style="cursor:pointer;position:absolute;right:0px;top:-1px;z-index:1" onclick="foldDaumPostcode()" alt="접기 버튼">
 ...
 이름<input placeholder="이름" type="text" name="name" value="<?=set_value_data($user,'name')?>"/>
 <?=form_error('name',false,false)?>
 <br/>
 성별 
