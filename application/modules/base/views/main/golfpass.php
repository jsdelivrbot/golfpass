                             ...
                             <a href="<?=site_url(shop_product_uri."/get/{$products_panel[$i]->id}")?>">
                                 <figure>
                                    ...
                                    <!-- // 이부분 수정 -->
                                             ...
                                             <span class="position-absolute text-light price" style="text-shadow: 0 0 7px rgba(0,0,0,1);"><?=my_number_format(_cal_apply_exchangeRate_and_margin_to_price($products_panel[$i]->price))?></span>
                                     </div>
                                     ...
                                     <figcaption class="rounded-bottom d-flex align-items-center justify-content-between p-3 bg-light">
                                             ...
                                             <div class="d-flex flex-column align-items-center">
                                                     ...
                                                     <span><?=(round(($products_panel[$i]->avg_score)*10))/10?></span>
                                                     <?php }?>
                                             </div>
                                     </figcaption>
                                    </figure>
            ...
            <div class="row" style="width:100%;">
                ...
                <div class="d-flex flex-wrap">
                    ...
                    <figure><a href="http://www.timescar-rental.kr/af/7822000076/kr/" target="_balnk">
                        <img src="/public/sangmin/img/partner/partner_timescar.png" alt=""></a>
                    </figure>
                    <figure>
