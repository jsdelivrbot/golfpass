(function ($) {
    ...
    traveltour_sf_menu.prototype = {
        ...
        init_slidebar: function () {
            ...
            $(window).on('traveltour-navigation-slider-bar-animate', function () {
                t.animate_slidebar_pos();
            });
    ...
    $.fn.traveltour_mobile_menu = function (args) {
        ...
        var extensions = {
            offCanvas: {
                pageNodetype: '.traveltour-body-outer-wrapper'
            }
        };
            ...
            $(window).on('scroll traveltour-set-sticky-navigation', function () {
                ...
                if (!t.sticky_nav.hasClass('traveltour-fixed-navigation')) {
                    ...
                    if ($(window).scrollTop() + page_offset > t.sticky_nav.offset().top) {
                        ...
                        if (logo_padding > 0) {
                            ...
                            t.sticky_nav_logo.css({
                                ...
                                'width': 'auto'
                            }); // set for css animation
                            t.sticky_nav.addClass('traveltour-animate-logo-height');
                        }

                        setTimeout(function () {
                            t.sticky_nav.addClass('traveltour-animate-fixed-navigation');
                        }, 10);
                        setTimeout(function () {
                    ...
                    if ($(window).scrollTop() + page_offset <= placeholder.offset().top) {
                        ...
                        setTimeout(function () {
                            t.sticky_nav.removeClass('traveltour-animate-fixed-navigation traveltour-animate-logo-height');
                        }, 10);
                        setTimeout(function () {
                            t.sticky_nav.css('height', '');
                            t.sticky_nav_logo.css({
